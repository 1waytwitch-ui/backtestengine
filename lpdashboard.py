...
# ----------------------------------------------------------------------
# Fonctions de calcul — mécanique (liquidité concentrée)
...
sec("◎", "TA POSITION LP",
    "Renseigne les deux actifs de la position. Les valeurs par défaut (WETH/USDC) sont un exemple — remplace-les par ta propre paire.")
...
tile_grid([
    ...
    tile(
        ...
        f"{x_now:,.4f} {token_a_symbol} · {y_now:,.4f} {token_b_symbol}",
        f"Soit ${x_now*prix_a_now:,.0f} en {token_a_symbol} et ${y_now*prix_b_now:,.0f} en {token_b_symbol}",
        "m-value-blue",
    ),
])
