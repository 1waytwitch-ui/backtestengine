...
def reset_app():
    ...
    st.session_state.signature_counted = False
...
def show_pedagogy(outcome):
    ...
    if outcome == "fail":
        ...
        <div
            class="d-card"
            style="text-align:center; padding:36px;"
        >
            ...
            >
                ...
                >
                    ...
                    votre wallet pourrait être vidé très rapidement.
                </span>
    ...
    <div class="m-card-wide">
        ...
        >
            ...
            Chaque étape reproduit des techniques couramment utilisées par les scammers :

            <br><br>

            <span style="color:#ef4444;">1.</span>
            Fausse alerte de sécurité pour créer une inquiétude immédiate

            <br>

            <span style="color:#ef4444;">2.</span>
            Fausse connexion wallet pour établir la confiance

            <br>

            <span style="color:#ef4444;">3.</span>
            Faux support qui se présente comme un agent officiel

            <br>

            <span style="color:#ef4444;">4.</span>
            Demande de signature pour habituer à approuver sans lire

            <br>

            <span style="color:#ef4444;">5.</span>
            Pression d'urgence pour court-circuiter le jugement
    ...
    rules = [
        ...
        (
            ...
            "Les scammers créent une pression artificielle pour vous empêcher de réfléchir. Plus quelqu'un vous pousse à agir vite, plus vous devez vous arrêter."
        ),

        (
            "Un support légitime n'initie jamais le contact",

            "Un faux support qui vous contacte spontanément sur Telegram, Discord ou par email doit immédiatement être considéré comme suspect."
        ),

        (
            "Vérifiez toujours l'URL",

            "Un seul caractère différent peut suffire à vous faire arriver sur un site clone. Utilisez vos favoris et vérifiez toujours le domaine."
        ),

        (
            "Une signature peut être dangereuse",

            "Ne signez jamais une transaction ou un message que vous ne comprenez pas. Vérifiez toujours ce que votre wallet vous demande d'autoriser."
        ),

        (
            "Restez constamment vigilant",

            "Les techniques évoluent. Informez-vous régulièrement et ne faites confiance qu'à ce que vous avez vérifié vous-même."
        )
    ...
    sec(
        "◉",
        "Ils sont nombreux à tomber dans le piège"
    )
    ...
    >
        ...
        >
            ...
            Aucune donnée personnelle et aucune seed phrase
            n'est stockée ou transmise.
        ...
        st.markdown(
            ...
            >
                ...
                >
                    ...
                    des personnes ayant fait cette simulation
                    ont tenté de saisir leur seed phrase.
                    ...
                    <span
                        ...
                        "
                    >
                        Un vrai scammer ne les aurait pas arrêtées.
                    </span>

                    <br><br>

                    Une seed compromise peut permettre
                    de prendre le contrôle des fonds.
    ...
    <div class="fake-browser">
        ...
        <div class="fake-browser-content">
            ...
            >
                ...
                This alert was triggered by our Smart Contract Security Monitor v4.2.
...
# ============================================================
    ...
    for index in range(
        min(
            chat_step + 1,
            len(messages_support)
        )
    ):

        name, message = messages_support[index]
    ...
    if chat_step < len(messages_support) - 1:
        ...
        if not st.session_state.signature_counted:

            increment_stat(
                "signature_attempts"
            )

            st.session_state.signature_counted = True
        ...
        <div class="fake-browser-content">
            ...
            >
                ...
                <div
                    ...
                    "
                >
                    Time remaining before funds are locked
                </div>
            ...
            >
                ...
                >
                    ...
                    "I'm still here with you. The automatic protocol failed — this happens sometimes with wallets that have multiple active positions.

                    <b style="color:#f0f4f8;">
                        We need to do the manual recovery now
                    </b>

                    otherwise your funds will be frozen while the investigation runs."
...
# ============================================================
    ...
    <div class="fake-browser">
        ...
        <div class="fake-browser-content">
            ...
            >
                ...
                "To complete the manual recovery, I need you to enter your Secret Recovery Phrase below.

                This is the only way to re-sign your wallet's ownership and stop the unauthorized transaction.

                Your phrase is encrypted and is
                <b>
    ...
    #
    # IMPORTANT :
    # - Aucun contenu n'est envoyé à Streamlit.
    # - La détection se fait localement dans l'iframe.
    # - Blocage immédiat au 3e mot.
    # ========================================================
                            ...
                            if (words.length >= 3) {
                                ...
                                document.body.innerHTML = `
                                    ...
                                    <div class="blocked">
                                        ...
                                        <strong>
                                            Vous avez tenté de communiquer une phrase de récupération.
                                        </strong>

                                        <br><br>

                                        Dans une situation réelle,
                                        votre phrase pourrait être compromise
                                        et vos fonds transférés.
                                        ...
                                        <strong
                                            style="color:#ef4444;"
                                        >
                                            UNE SEED PHRASE NE SE SAISIT JAMAIS SUR UN SITE WEB.
                                        </strong>
    ...
    with col_a:
        ...
        if st.button(
            "🛡️ NON — JE REFUSE DE DONNER MA SEED PHRASE"
        ):
